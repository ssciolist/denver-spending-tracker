...
save_and_open_page
    ...
    expect(page).to_not have_content(purchase3.programs.first.name)
    expect(page).to_not have_content(purchase3.vendors.first.name)
    expect(page).to_not have_content(purchase3.description)
    expect(page).to_not have_content(purchase3.amount)
    expect(page).to_not have_content(purchase3.transaction_date)
    expect(page).to_not have_content(purchase3.payment_date)
